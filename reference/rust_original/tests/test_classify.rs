...
use idtaxa::types::{ClassificationResult, ClassifyConfig, OutputType, StrandMode, TrainConfig};
...
fn train_standard_model() -> idtaxa::types::TrainingSet {
...
fn train_problem_model() -> idtaxa::types::TrainingSet {
...
fn train_singleton_model() -> idtaxa::types::TrainingSet {

...
use idtaxa::fasta::{read_fasta, write_classification_tsv};
use idtaxa::sequence::remove_gaps;
use idtaxa::training::learn_taxa;
use idtaxa::types::{ClassifyConfig, OutputType, StrandMode, TrainConfig};
...
fn test_full_pipeline_e2e() {
    ...
    let data_dir = manifest_dir.parent().unwrap().join("tests").join("data");
    ...
    let mut rng = idtaxa::rng::RRng::new(42);
